...
def test_xfer_handler_update_state(xfer_handler, xfer_txn, payment_address_2, payment_address):
    ...
    assert token_state.get((libsovtoken_address_to_address(payment_address) + ":1").encode(), isCommitted=False) is None
