...
from plenum.server.plugin.sovtoken.src.main import integrate_plugin_in_node as enable_token
from plenum.server.plugin.sovtoken_fees.src.main import integrate_plugin_in_node as enable_fees
from plenum.server.plugin.sovtoken.src.util import register_token_wallet_with_client
from plenum.server.plugin.sovtoken.test.helper import send_get_utxo, send_xfer

# fixtures, do not remove
from plenum.test.conftest import *
from plenum.server.plugin.sovtoken.test.conftest import trustee_wallets, SF_address, \
    seller_address, seller_token_wallet, SF_token_wallet, public_minting, \
    tokens_distributed
from plenum.server.plugin.sovtoken.test.test_public_xfer_1 import user1_address, \
...
# Wallet should have support to track sovtoken_fees
