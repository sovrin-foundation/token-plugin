import pytest
from plenum.server.plugin.sovtoken_fees.src.static_fee_req_handler import \
...
from plenum.server.plugin.sovtoken_fees.test.helper import get_fees_from_ledger, \
...
from plenum.server.plugin.sovtoken.test.helper import decode_proof
from plenum.test.conftest import get_data_for_role
from plenum.server.plugin.sovtoken.test.conftest import build_wallets_from_data
...
def test_non_trustee_set_fees(looper, nodeSetWithIntegratedTokenPlugin,
    ...
    """
    Only trustees can change the sovtoken_fees
    """
    fees = {
        NYM: 1,
        XFER_PUBLIC: 2
...
def test_get_fees(fees_set, looper, nodeSetWithIntegratedTokenPlugin,
    ...
    """
    Get the sovtoken_fees from the ledger
    """
...
def test_change_fees(fees_set, looper, nodeSetWithIntegratedTokenPlugin,
    ...
    """
    Change the sovtoken_fees on the ledger and check that sovtoken_fees has changed
    """
