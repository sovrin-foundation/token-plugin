...
def test_plugin_and_or_rule_same_role(write_auth_req_validator, write_request_validation,
    ...
    validate(
        ...
        valid_actions=[
            ...
            ({TRUSTEE: 2, STEWARD: 3}, False, 0),
            ({TRUSTEE: 3, STEWARD: 3}, False, 0),

            ({TRUSTEE: 2, STEWARD: 3}, True, None),
            ({TRUSTEE: 3, STEWARD: 3}, True, None),

            ({TRUSTEE: 2, STEWARD: 3}, True, 0),
            ({TRUSTEE: 3, STEWARD: 3}, True, 0),
        ],
...
def test_plugin_or_and_rule_diff_roles(write_auth_req_validator, write_request_validation,
    ...
    validate(
        ...
        valid_actions=[
            ...
            ({TRUSTEE: 1, STEWARD: 2}, False, 0),
            ({TRUSTEE: 2, STEWARD: 2}, False, 0),
            ({TRUSTEE: 1, STEWARD: 3}, False, 0),
            ({TRUSTEE: 2, STEWARD: 3}, False, 0),
            ({TRUSTEE: 3, STEWARD: 3}, False, 0),
            ...
            ({TRUSTEE: 1, STEWARD: 2}, True, 0),
            ({TRUSTEE: 2, STEWARD: 2}, True, 0),
            ({TRUSTEE: 1, STEWARD: 3}, True, 0),
            ({TRUSTEE: 2, STEWARD: 3}, True, 0),
            ({TRUSTEE: 3, STEWARD: 3}, True, 0),
...
def test_plugin_complex(write_auth_req_validator, write_request_validation,
    ...
    validate(
        ...
        valid_actions=[
            ...
            ({TRUSTEE: 3, STEWARD: 2}, False, 0),
            ({TRUSTEE: 3, STEWARD: 3}, False, 0),
            ({TRUSTEE: 3, STEWARD: 2}, True, 0),
            ({TRUSTEE: 3, STEWARD: 3}, True, 0),
            ...
            ({TRUSTEE: 3, TRUST_ANCHOR: 2}, False, 0),
            ({TRUSTEE: 3, TRUST_ANCHOR: 3}, False, 0),
            ({TRUSTEE: 3, TRUST_ANCHOR: 2}, True, 0),
            ({TRUSTEE: 3, TRUST_ANCHOR: 3}, True, 0),
