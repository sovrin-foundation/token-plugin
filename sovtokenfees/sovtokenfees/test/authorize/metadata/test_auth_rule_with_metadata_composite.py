...
def test_plugin_or_rule_one_amount_same_role(write_auth_req_validator, write_request_validation,
    ...
    validate(
        ...
        valid_actions=[
            ...
            ({TRUST_ANCHOR: 1}, True, 0),
            ({TRUST_ANCHOR: 2}, True, 0),
            ({TRUST_ANCHOR: 3}, True, 0),

            ({TRUST_ANCHOR: 1}, False, 0),
            ({TRUST_ANCHOR: 2}, False, 0),
            ({TRUST_ANCHOR: 3}, False, 0),
        ],
        all_signatures=[{'101': 1}], is_owner=False, amount=0,
        write_auth_req_validator=write_auth_req_validator,
        write_request_validation=write_request_validation
    )
